<?php
    ...
    addnav($menu, $lGoToPost, "feeding.php?f=$num&i=$i&t=$t$GetVars");
    ...
    switch($mod) {
        case "update":
            ...
            header("Location: feeding.$ext?f=$num&i=$i&t=$t$GetVars");
            exit;
        case "delete":
            ...
            if($i==$t){
                ...
                header("Location: feeding.php?f=$num&i=$t&t=$t$GetVars");
            }
            exit;
            break;
    }
...
?>
<form action="<?php echo $PHP_SELF; ?>" method="POST" target="feeder">
...
<input type="hidden" name="author" value="<?php echo $mtext["author"]; ?>" size="35" style="font-family:Verdana, Geneva; font-size:8pt;border: 1 solid; border-color: #768abe;"  />
<input type="hidden" name="email" value="<?php echo $mtext["email"]; ?>" size="35" style="font-family:Verdana, Geneva; font-size:8pt;border: 1 solid; border-color: #768abe;"  />
<input type="hidden" name="subject" value="<?php echo $mtext["subject"]; ?>" size="35" style="font-family:Verdana, Geneva; font-size:8pt;border: 1 solid; border-color: #768abe;"  />
...
<tr>
  <th><font color="#768abe">&nbsp;<?php echo $lFormAttachment?> [<?php echo $rec["id"]; ?>]:</font></th>
  <td><input type="Text" name="new_attachment[<?php echo $rec["id"]; ?>]" value="<?php echo $rec["filename"]; ?>" size="35" style="font-family:Verdana, Geneva; font-size:8pt;border: 1 solid; border-color: #768abe;"" class="TEXT" />&nbsp;&nbsp;<input TYPE="checkbox" name="del_attachment[<?php echo $rec["id"]; ?>]" VALUE="true" /> delete attachment</td>
</tr>
<?php
  }
}
...
<tr>
    ...
    <td colspan=2 width="100%" nowrap="nowrap" align="left"><table cellpadding="5" cellspacing="0" border="0"><tr><td align="CENTER" valign="TOP"><font face="courier"><textarea name="body" cols="35" rows="12" wrap="VIRTUAL" style="font-family:Verdana, Geneva; font-size:8pt; border: 1 solid; border-color: #768abe; wrap=virtual; overflow:auto;"><?php echo htmlspecialchars($mtext["body"]); ?></textarea></font></td></tr></table></td>
</tr>
</td>
</tr>
<tr>
