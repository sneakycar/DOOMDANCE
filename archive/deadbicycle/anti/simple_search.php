...
<table class="PhorumListTable" width="85%" cellspacing="0" cellpadding="4" border="0">
  <tr>
    <td bgcolor="#ffffff" valign="TOP" nowrap="nowrap"><font color="#663399">&nbsp;<?php echo "$lSearchResults: $totalFound";?></font></td>
  </tr>
<tr><td width="85%" valign="TOP" bgcolor="#ffffff"><font color="#768abe">
<?php
    if($rows>0){
