...
// one-time-set settings
  $PHORUM['main_table']='television';
  $PHORUM['dbtype']='mysql';

// Global Settings
  $PHORUM['started']=1;
  $PHORUM['DefaultDisplay']='30';
  $PHORUM['DefaultEmail']='gerald@deadbicycle.com';
  $PHORUM['PhorumMailCode']='';
  $PHORUM['UseCookies']='1';
  $PHORUM['SortForums']='1';
  $PHORUM['ActiveForums']='5';
  $PHORUM['TimezoneOffset']='-1';

  $PHORUM['forum_url']='http://www.deadbicycle.com/anti';
  $PHORUM['admin_url']='http://www.deadbicycle.com/anti/love/index.php';
  ...
  $PHORUM['DatabaseName']='superdea_anti';
  $PHORUM['DatabaseUser']='superdea_russian';
  $PHORUM['DatabasePassword']='dave';
