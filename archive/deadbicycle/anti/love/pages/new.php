...
<tr>
  ...
  <option value="n" <?php if($moderation=='n') echo 'selected'; ?>>No</option>
  <option value="a" <?php if($moderation=='a') echo 'selected'; ?>>All Messages Before Posted</option>
  <option value="r" <?php if($moderation=='r') echo 'selected'; ?>>All Messages After Posted</option>
</select></td>
</tr>
<?php } ?>
<tr>
