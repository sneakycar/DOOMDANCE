...
// $Id: read.php,v 1.82 2002/02/12 19:53:16 yayel Exp $
  ...
  if($action!=0 && ($action==1 || $action==2)){
    ...
    if($msg->numrows()==0){
      Header("Location: http://www.deaddeaddead.com/anti/no.php");
      exit;
    }
...
//////////////////////////
  ...
  //////////////////////////
    ...
    if(!$$phflat)
      addnav($menu2, $lReplyMessage, "postreply.php?f=$f&i=$id&s=$subject&t=$t$GetVars");
...
<DIV ALIGN=CENTER><table width="55%" cellspacing="0" cellpadding="2" border="0">

<?php if ($header_rows==0 || $body_rows==0) { ?>
<tr>
    <td bgcolor="#c7ccd7"><FONT color="<?php echo $ForumTableHeaderFontColor; ?>">&nbsp;<?php echo $lViolationTitle; ?></font></td>
</tr>
<tr>
    <td bgcolor="#ffffff" width="100%" valign="top"><font color="<?php echo $ForumTableBodyFontColor2; ?>"><?php echo $lNotFound; ?></td>
</tr>
<table width="55%" cellspacing="0" cellpadding="2" border="0">
<tr>
<td nowrap="nowrap" align="right" bgcolor="#ffffff"><FONT COLOR="#768abe"><?php echo $MessageNav; ?></FONT></TD>    
</tr>
</table>
<?php }else{
  ...
  while(is_array($head_row) && is_array($body_row)){
    if($head_row["id"]==$body_row["id"]){
      ...
      if($head_row["userid"]>0 && isset($users[$head_row["userid"]])){
        $name=$users[$head_row["userid"]];
        $author=$qauthor=$name["name"];
        $email=$name["email"];
        $host="";
...
?>
<a name="reply_<?php echo $head_row["id"]; ?>"></a></DIV>
<DIV ALIGN="CENTER">


<table width="55%" cellspacing="0" cellpadding="2" border="0">
<TR><TD align="LEFT" colspan=2 BGCOLOR="#f7ff19"><?php echo $author; ?>&nbsp;<?php echo $host; ?>&nbsp;&nbsp;&nbsp;[<?php echo $datestamp; ?>]</TD></TR>
<TR><td align="LEFT" colspan=2 BGCOLOR="#E7EAF1"><FONT class="PhorumTableHeader" color="#768abe">&nbsp;<?php echo $subject; ?></font></td></TR>
<tr>
    <td colspan=2 bgcolor="#ffffff" valign="TOP"><table width="55%" cellspacing="0" cellpadding="2" border="0">
...
<TR>
<TD colspan="2" ALIGN="RIGHT" BGCOLOR="#ffffff"><TABLE WIDTH="87" BORDER="0" CELLPADDING="1" CELLSPACING="0"><TR><TD align="center" bgcolor="#f7ff19">
<B><FONT color='#669933' class="PhorumNav">[<?php echo "<a href=\"$forum_url/moderator.$ext?mod=edit&f=$ForumId&i=$id&t=$thread$GetVars\">";?><?php echo $lModEdit; ?></a>]&nbsp;</font>
<FONT color='#669933' class="PhorumNav">[<a href="javascript:delmsg('<?php echo "$forum_url/moderator.$ext?mod=delete&f=$ForumId&i=$rec_id&t=$thread$GetVars";?>')"><?php echo $lModDelete; ?></a>]</font>
</B></td></TD></TR></TABLE>
</tr>
...
<?php } // if($phorum_user ...
?>
    <TR><td colspan="2" valign="TOP" align="RIGHT" nowrap="nowrap" bgcolor="#e7eaf1"><?php echo "<a href=\"postreply.php?f=$f&i=$id&s=$subject&t=$t$GetVars\"";?> onmouseover="window.status='reply';return true" onmouseout="window.status=''; return true"><B><FONT color='#768abe' class="reply"><?php echo $lReplyMessage; ?></B></a></td>
</tr>

<tr>
    <td height="11" align="left" bgcolor="#ffffff">

<?php echo "<a href=\"$read_page.$ext?$prev_link$GetVars\"";?> onmouseover="window.status='i must have a newer one.  message by message, i will read them all.';return true" onmouseout="window.status=''; return true"><IMG SRC="images/next4.jpg" height="8" width="8" border="0"></A>&nbsp;&nbsp;<?php echo "<a href=\"$read_page.$ext?$next_link$GetVars\"";?> onmouseover="window.status='i even love the older topics, and will read those too.  even if i have already read them.';return true" onmouseout="window.status=''; return true"><IMG SRC="images/next3.jpg" height="8" width="8" border="0"></A></TD>


    <td height="11" align="right" bgcolor="#ffffff"><?php echo "<a href=\"$read_page.$ext?f=$num&t=$thread&a=1$GetVars\"";?> onmouseover="window.status='head on over to the next newest thread.';return true" onmouseout="window.status=''; return true"><IMG SRC="images/next2.jpg" height="8" width="17" border="0"></A>&nbsp;&nbsp;<?php echo "<a href=\"$read_page.$ext?f=$num&t=$thread&a=2$GetVars\"";?> onmouseover="window.status='strap back in time and look for the next oldest thread, my friend.';return true" onmouseout="window.status=''; return true"><IMG SRC="images/next1.jpg" height="8" width="17" border="0"></A></td></TR>

<tr>
    <td colspan=2 valign="TOP" align="RIGHT" width=100% bgcolor="#ffffff"><B><?php echo "<a href=\"$read_page.$ext?f=$num&i=$id&t=$thread&v=f$GetVars\"";?> onmouseover="window.status='show all replies';return true" onmouseout="window.status=''; return true">Let's see 'em all baby!</A></B></td></TR>
...
<tr>
<TD colspan="2" ALIGN="RIGHT" BGCOLOR="#ffffff"><TABLE WIDTH="87" BORDER="0" CELLPADDING="1" CELLSPACING="0"><TR><TD align="center" bgcolor="#f7ff19">
<B><FONT color='#669933' class="PhorumNav">[<?php echo "<a href=\"$forum_url/moderator.$ext?mod=edit&f=$ForumId&i=$rec_id&t=$thread$GetVars\">";?><?php echo $lModEdit; ?></a>]</font>
<B><FONT color='#669933' class="PhorumNav">[<a href="javascript:delmsg('<?php echo "$forum_url/moderator.$ext?mod=delete&f=$ForumId&i=$rec_id&t=$thread$GetVars";?>')"><?php echo $lModDelete; ?></a></font>
</td></TR></TABLE></TD>
</tr>
...
?>
<tr>
    <td height="11" colspan="2" nowrap="nowrap" align="right" bgcolor="#E7EAF1"><FONT COLOR="#768abe"></FONT><B><?php echo "<a href=\"postreply.php?f=$f&i=$id&s=$subject&t=$t$GetVars\">";?><FONT color='#768abe' class="reply"><?php echo $lReplyMessage; ?></a></B></font></TD></tr>
<tr>
    <td height="11" colspan="2" align="right" bgcolor="#ffffff"><?php echo "<a href=\"$read_page.$ext?f=$num&t=$thread&a=1$GetVars\"";?> onmouseover="window.status='head on over to the next newest thread.';return true" onmouseout="window.status=''; return true"><IMG SRC="images/next2.jpg" height="8" width="17" border="0"></A>&nbsp;&nbsp;<?php echo "<a href=\"$read_page.$ext?f=$num&t=$thread&a=2$GetVars\"";?> onmouseover="window.status='strap back in time and look for the next oldest thread, my friend.';return true" onmouseout="window.status=''; return true"><IMG SRC="images/next1.jpg" height="8" width="17" border="0"></A></td></TR>
<TR><TD colspan="2" align="right" BGCOLOR="#ffffff"><B><?php echo "<a href=\"$read_page.$ext?f=$num&i=$id&t=$thread&v=t$GetVars\"";?> onmouseover="window.status='show all replies';return true" onmouseout="window.status=''; return true">one at a time, please...</A></b></TD></TR>
</table>
<?php
    unset($TopLeftNav);
  }
