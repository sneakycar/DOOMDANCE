<?php
  ...
  $lLoginError      = ""; // You username and password did not match.  Please try again.
  ...
  $lEditProfileError= ""; // Sorry you are not logged in and/or its not your profile.  You can't edit it.
  $lBack            = ""; // Back
