...
<table border="0" cellpadding="1" cellspacing="0" width="217">
...
?>
<B><?php echo $rating; ?></B>&nbsp;</TD><TD><B><?php echo $artist; ?> </B>- <?php echo $body; ?></TD>
</td>
</tr>
<TR>
...
<TABLE colspan="3" width="215" border="0" cellspacing="0" cellpadding="0"><TR HEIGHT="8"><TD colspan="3">&nbsp;</TD></TR><TR align="left"><TD><A HREF="http://www.deadbicycle.com/anti/feeding.php?f=7&i=9&t=9" target="feeder" onmouseover="window.status='back to the good old fashioned news';return true" onmouseout="window.status='';return true"><img src="../../../img/file2.gif" width="22" height="19" border="0"></A><img src="../../../img/file.gif" width="22" height="19" border="0">
<?php if(!empty($phorum_user["moderator"])){ ?>
