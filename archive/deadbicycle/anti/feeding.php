...
// $Id: read.php,v 1.82 2002/02/12 19:53:16 yayel Exp $
  ...
  if ($$phflat) {
    $sSQL = "SELECT $ForumTableName.id AS id, $ForumTableName.thread AS thread, body from $ForumTableName, ".$ForumTableName."_bodies WHERE $ForumTableName.approved = 'Y' AND $ForumTableName.thread = ".$thread." AND $ForumTableName.id = ".$ForumTableName."_bodies.id ORDER BY id desc";
  } else {
...
<table bgcolor="white" class="PhorumListTable" width="<?php echo $ForumTableWidth; ?>" cellspacing="0" cellpadding="2" border="0">
<tr>
...
<table border="0" cellpadding="3" cellspacing="0" width="217">
<tr>
<td width="4" class="lime">&nbsp;</td>
<td class="lime">
<div align="left"></TD>
</TD></TR>
<tr>
<td colspan="3" width="212"><P>
<?php
...
<TR>
<TABLE width="212" border="0" cellspacing="0" cellpadding="0"><TR align="right"><TD>

<?php if(!$$phflat){ ?>
<?php if(!empty($phorum_user["moderator"])){ ?>
<TR>
<TD colspan="2" ALIGN="RIGHT" BGCOLOR="#ffffff"><TABLE WIDTH="187" BORDER="0" CELLPADDING="1" CELLSPACING="0"><TR><TD align="center" bgcolor="#f7ff19">
<B><FONT color='#669933' class="PhorumNav">[<?php echo "<a href=\"$forum_url/moderator.$ext?mod=edit&f=$ForumId&i=$id&t=$thread$GetVars\">";?><img src="http://www.deaddeaddead.com/img/editfeed.gif" width="21" height="19" border="0"></a>]&nbsp;</font>
...
<?php echo "<a target=\"madness\" href=\"feeder.php?f=$f&i=$id&s=$subject&t=$t$GetVars\">";?><img src="http://www.deaddeaddead.com/img/newfeed.gif" width="21" height="19" border="0"></A>
<?php echo "<a target=\"madness\" href=\"$forum_url/feedmoderator.php?mod=edit&f=$ForumId&i=$rec_id&t=$thread$GetVars\">";?><img src="http://www.deaddeaddead.com/img/editfeed.gif" width="21" height="19" border="0"></a>
<a href="javascript:delmsg('<?php echo "$forum_url/moderator.$ext?mod=delete&f=$ForumId&i=$rec_id&t=$thread$GetVars";?>')"><img src="http://www.deaddeaddead.com/img/trash.gif" width="21" height="19" border="0"></a>
