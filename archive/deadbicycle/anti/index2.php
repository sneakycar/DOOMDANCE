...
<table width="<?php echo $table_width; ?>" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="red" valign="TOP" nowrap="nowrap"><?php echo $TopNav; ?></td>
  </tr>
</table>
<?php
  }
...
<tr>
    <td class="PhorumTableHeader" width="5%" colspan="3" bgcolor="purple"><FONT color="<?php echo $table_header_font_color; ?>">&nbsp;<?php echo $lAvailableForums;?></font></td>
</tr>
<?php
  if(isset($q)){
