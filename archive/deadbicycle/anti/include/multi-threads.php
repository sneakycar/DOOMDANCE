<?php
  ...
  $t_gif="<img src=\"$forum_url/images/t2.gif\" width=\"12\" height=\"21\" border=\"0\">";
  $l_gif="<img src=\"$forum_url/images/l2.gif\" width=\"12\" height=\"21\" border=\"0\">";
  $p_gif="<img src=\"$forum_url/images/p2.gif\" width=\"9\" height=\"21\" border=\"0\">";
  $m_gif="<img src=\"$forum_url/images/m2.gif\" width=\"9\" height=\"21\" border=\"0\">";
  $c_gif="<img src=\"$forum_url/images/c2.gif\" width=\"9\" height=\"21\" border=\"0\">";
  $i_gif="<img src=\"$forum_url/images/i2.gif\" width=\"12\" height=\"21\" border=\"0\">";
  $n_gif="<img src=\"$forum_url/images/n2.gif\" width=\"9\" height=\"21\" border=\"0\">";
  $file_gif="<img src=\"$forum_url/images/file.gif\" width=\"9\" height=\"7\" border=\"0\">";
  ...
  function echo_data($image, $topic, $row_color){
    ...
    if($id==$topic["id"] && $read=true){
        ...
        $subject.="<a  target=\"threads\" href=\"$read_page.$ext?f=$num&i=".$topic["id"];
	$reply_name='';
	if ($$phflat) {
    ...
    if($UseCookies){
      ...
      if($isnew){
	$subject=str_replace("$topic[subject]","<b>$topic[subject]</b>",$subject);
	$subject.="&nbsp;<img src=\"../anti/images/file.gif\" width=\"7\" height=\"9\" border=\"0\">";
      }
    }
...
?>
<tr valign=middle>
<td WIDTH="55%" class="PhorumListRow" <?php echo bgcolor($bgcolor);?>><?php echo $subject;?></td>
<td WIDTH="45%" class="PhorumListRow" <?php echo bgcolor($bgcolor);?> nowrap="nowrap"><font color="<?php echo $font_color;?>"><?php echo $author;?></font></td>
<td WIDTH="10%" class="PhorumListRow" <?php echo bgcolor($bgcolor);?> nowrap="nowrap"><font color="<?php echo $font_color;?>"><?php echo $datestamp;?>&nbsp;</font></td>
</tr>
<?php
  }
...
<tr>
    <td width="55%" class="PhorumListHeader"<?php echo bgcolor($ForumTableHeaderColor);?>><font color="<?php echo $ForumTableHeaderFontColor; ?>">&nbsp;<?php echo $lTopics;?><img src="images/trans.gif" border="0" width=1 height=24 align="absmiddle"></font></td>
    <td width="45%" class="PhorumListHeader"<?php echo bgcolor($ForumTableHeaderColor);?> nowrap="nowrap" width=150><font color="<?php echo $ForumTableHeaderFontColor; ?>"><?php echo $lAuthor;?>&nbsp;</font></td>
    <td width="10%" class="PhorumListHeader"<?php echo bgcolor($ForumTableHeaderColor);?> nowrap="nowrap" width=150><font color="<?php echo $ForumTableHeaderFontColor; ?>"><?php echo $lDate;?></font></td>
</tr>
<?php
  thread();
?>
