...
?>
<form name="sendmessageform" action="feedit.php" method="post" target="feeder" enctype="<?php echo $enctype ?>" onSubmit="post.disabled=true;">
...
<INPUT TYPE="hidden" name="subject" value="<?php echo $p_subject; ?>">
...
<TR HEIGHT="11"><TD><FONT COLOR="#768abe"><B>What do you want to unleash:</B></FONT></TD></TR>
<TR HEIGHT="4"><TD>&nbsp;</TD></TR>
       <TR> <td width="100%" nowrap="nowrap" align="left"><table cellpadding="0" cellspacing="0" border="0"><tr><td align="CENTER" valign="TOP"><font face="courier"><textarea class="forumnormal" name="body" cols="30" rows="6" wrap="VIRTUAL" border: 1 solid; border-color: #768abe;" wrap=virtual style="font-family:Verdana, Geneva; font-size:8pt; overflow:auto;"><?php echo $p_body; ?></textarea></font></td></tr></table></td>
    </tr><TR><TD>&nbsp;</TD></TR>
<TR><TD>
